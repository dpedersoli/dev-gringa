...
const pt = {
  ...
  intakeKicker: "Perfil",
  intakeTitle: "Perguntas para o perfil",
  intakeLead:
    "Nenhuma pergunta pede o nome do campo. As respostas preenchem o perfil. Depois você edita o que quiser em Perfil.",
  intakeNameNote: "O nome e o idioma da tela não entram aqui. Eles continuam no perfil.",
  intakeEditInstead: "Prefiro preencher os campos",
  intakeLink: "Responder pelas perguntas",
  intakeSubmit: "Preencher o perfil",
  intakeError:
    "Faltou uma resposta neste grupo. Marque uma opção ou Ainda não sei. O que você já marcou continua nesta tela.",
  intakeUnset: "Ainda não sei",
  intakeUnsetHint: "Ainda não sei apaga este campo quando nenhuma outra opção estiver marcada.",
  intakeYears: "Há quanto tempo entregar software é o seu trabalho?",
  intakeYearsKeep: "Continuo com os {n} anos que já estão no perfil",
  intakeYearsUnder3: "Ainda não fecho 3 anos",
  intakeYears3: "Já faz de 3 a 5 anos",
  intakeYears5: "Passa de 5 e não chega a 8",
  intakeYears8: "Oito anos ou mais",
  intakeStack: "O que você já colocou no ar e defenderia numa conversa?",
  intakeStackOther: "Outra, separada por vírgula",
  intakeMarkets: "Qual horário de reunião você aguenta com frequência?",
  intakeMarketUs: "Fim da tarde no horário de Nova York",
  intakeMarketUk: "Manhã no horário de Londres",
  intakeMarketCa: "Meio do dia com o Canadá",
  intakeMarketEu: "Manhã cedo com a Europa",
  intakeMarketAu: "Noite no horário da Austrália",
  intakeContracts: "Quando um trabalho termina, o que você quer que aconteça?",
  intakeContractShort: "Fico alguns meses e sigo para o próximo",
  intakeContractLong: "Fico no time, com salário todo mês",
  intakeContractFreelance: "Entrego um projeto e saio",
  intakeSalary: "Uma proposta chega, em dólares por ano. Qual conversa você abre?",
  intakeSalaryUnsure: "Qualquer número. Ainda estou formando isso",
  intakeSalary60: "Até 60 mil",
  intakeSalary90: "De 60 a 90 mil",
  intakeSalaryPlus: "Acima de 90 mil",
  intakeVisa: "Se a empresa disser que você precisa morar no país da vaga, o que você faz?",
  intakeVisaRemote: "Continuo onde estou e trabalho de casa",
  intakeVisaRelocate: "Eu me mudo se eles patrocinarem a mudança",
  intakeVisaAuth: "Eu já posso trabalhar nesse país",
  intakeKind: "Que lugar combina com o que você quer agora?",
  intakeKindProduct: "Um produto que já está no ar, com time de engenharia",
  intakeKindStartup: "Uma empresa ainda montando o produto e o time",
  intakeKindNetwork: "Alguém que me apresenta a várias empresas depois de uma triagem",
  intakeTrack: "Daqui a um ano, o que ocupa a maior parte do seu dia?",
  intakeTrackIc: "Código que eu entrego",
  intakeTrackManagement: "Pessoas que eu acompanho",
  intakeTrackBoth: "Os dois",
  intakeDomain: "Qual assunto você aguenta explicar toda semana?",
  intakeDomainDevtools: "Ferramenta para quem programa",
  intakeDomainFintech: "Dinheiro: pagamento, banco, folha",
  intakeDomainProductivity: "Organizar o dia de trabalho",
  intakeDomainInfra: "Onde o software roda: sistema, nuvem",
  intakeDomainPublishing: "Escrever e publicar na web",
  stack: "Stack",
  ...
  toastQuestions: "Perfil preenchido pelas perguntas. Você pode editar.",
...
const en: Dictionary = {
  ...
  intakeKicker: "Profile",
  intakeTitle: "Questions for the profile",
  intakeLead:
    "No question asks for the field name. The answers fill the profile. After that you edit whatever you want on Profile.",
  intakeNameNote: "Your name and the screen language stay on the profile.",
  intakeEditInstead: "I would rather fill the fields",
  intakeLink: "Answer the questions",
  intakeSubmit: "Fill the profile",
  intakeError:
    "This group is missing an answer. Mark an option or I don't know yet. What you already marked stays on this screen.",
  intakeUnset: "I don't know yet",
  intakeUnsetHint: "I don't know yet clears this field when no other option is marked.",
  intakeYears: "How long has shipping software been your job?",
  intakeYearsKeep: "Keep the {n} years already on the profile",
  intakeYearsUnder3: "I have not reached 3 years",
  intakeYears3: "It has been 3 to 5 years",
  intakeYears5: "Past 5 and short of 8",
  intakeYears8: "Eight years or more",
  intakeStack: "What have you shipped and would defend in a conversation?",
  intakeStackOther: "Something else, comma-separated",
  intakeMarkets: "Which meeting time can you keep often?",
  intakeMarketUs: "Late afternoon, New York time",
  intakeMarketUk: "Morning, London time",
  intakeMarketCa: "The middle of the day with Canada",
  intakeMarketEu: "Early morning with Europe",
  intakeMarketAu: "Evening, Australia time",
  intakeContracts: "When a piece of work ends, what do you want to happen?",
  intakeContractShort: "I stay a few months and move on",
  intakeContractLong: "I stay on the team, paid every month",
  intakeContractFreelance: "I deliver a project and leave",
  intakeSalary: "An offer arrives, in dollars per year. Which conversation do you open?",
  intakeSalaryUnsure: "Any number. I am still forming this",
  intakeSalary60: "Up to 60 thousand",
  intakeSalary90: "From 60 to 90 thousand",
  intakeSalaryPlus: "Above 90 thousand",
  intakeVisa: "If the company says you have to live in the country of the role, what do you do?",
  intakeVisaRemote: "I stay where I am and work from home",
  intakeVisaRelocate: "I move if they sponsor the move",
  intakeVisaAuth: "I can already work in that country",
  intakeKind: "Which place fits what you want now?",
  intakeKindProduct: "A product that is already live, with an engineering team",
  intakeKindStartup: "A company still building the product and the team",
  intakeKindNetwork: "Someone who introduces me to several companies after a screen",
  intakeTrack: "A year from now, what takes most of your day?",
  intakeTrackIc: "Code I ship",
  intakeTrackManagement: "People I support",
  intakeTrackBoth: "Both",
  intakeDomain: "Which subject can you explain every week?",
  intakeDomainDevtools: "A tool for people who write software",
  intakeDomainFintech: "Money: payments, banking, payroll",
  intakeDomainProductivity: "Organizing the workday",
  intakeDomainInfra: "Where software runs: system, cloud",
  intakeDomainPublishing: "Writing and publishing on the web",
  stack: "Stack",
  ...
  toastQuestions: "Profile filled from the questions. You can edit it.",
